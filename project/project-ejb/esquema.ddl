...
CREATE TABLE CUENTA_REFERENCIA (IBAN VARCHAR NOT NULL, FECHA_APERTURA DATE, NOMBRE_BANCO VARCHAR NOT NULL, PAIS VARCHAR, SALDO INTEGER NOT NULL, SUCURSAL VARCHAR, DIVISA_ABREVIATURA VARCHAR, PRIMARY KEY (IBAN))
...
CREATE TABLE CUENTA_FINTECH (IBAN VARCHAR NOT NULL, CLASIFICACION VARCHAR, FECHA_APERTURA DATE NOT NULL, FECHA_CIERRE DATE, CLIENTE_ID INTEGER, PRIMARY KEY (IBAN))
CREATE TABLE POOLED (IBAN VARCHAR NOT NULL, PRIMARY KEY (IBAN))
CREATE TABLE SEGREGATED (IBAN VARCHAR NOT NULL, COMISION INTEGER, C_REF_IBAN VARCHAR, PRIMARY KEY (IBAN))
...
CREATE TABLE usuario (ID INTEGER NOT NULL, ADMINISTRADOR BOOLEAN NOT NULL, CONTRASENA VARCHAR NOT NULL, ESTADO VARCHAR, C_CLIENTE_ID INTEGER, PERSONA_AUTORIZADA_ID INTEGER, PRIMARY KEY (ID))
...
ALTER TABLE DEPOSITADAPOOLEDREFERENCIA ADD CONSTRAINT FK_DEPOSITADAPOOLEDREFERENCIA_REFERENCIA FOREIGN KEY (REFERENCIA) REFERENCES CUENTA (IBAN)
...
ALTER TABLE SEGREGATED ADD CONSTRAINT FK_SEGREGATED_C_REF_IBAN FOREIGN KEY (C_REF_IBAN) REFERENCES CUENTA (IBAN)
