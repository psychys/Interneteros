...
public class LoginTestAdmin {
    ...
    public void login() {
        ...
        driver.findElement(By.id("Login-Form:Login-ID")).sendKeys("admin");
        driver.findElement(By.id("Login-Form:Login-Contraseña")).click();
        driver.findElement(By.id("Login-Form:Login-Contraseña")).sendKeys("admin");
